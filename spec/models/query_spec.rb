...
RSpec.describe Query, type: :model do
    describe "format_results" do
        ...
        it "should return value with appended 'K' if greater than 1000 and less than 1000000" do
        ...
        it "should return value with appened 'M' if greater 1000000 and less than 1000000000" do
        ...
        it "should return value with appended 'B' if greater 100000000 and less than 100000000000" do
            query = FactoryBot.create(:query, tweet_sum: 1000001)
